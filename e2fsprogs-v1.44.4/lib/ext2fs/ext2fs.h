...
//pfsck
extern errcode_t make_dblist(ext2_filsys fs, ext2_ino_t size, ext2_ino_t count, struct ext2_db_entry2 *list, ext2_dblist *retdblist);
//
...
#ifdef _ICOUNT_MERGE
extern void ext2fs_icount_merge(ext2_icount_t icount_src, ext2_icount_t icount_dest);
#endif
